...
@section('content')
    ...
    <div class="row" style="padding: 10px;">
        <div class="col s12 m5" style="margin-top: 15px;" >
        ...
        <div class="col s12 m7" style="margin-top: 15px;">
                    ...
                    <table class="striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$address->price}}</td>
                                <td>
                                    <a href="{{route('addresses.delete', $address->id)}}" class="btn tooltipped deleter"  style="padding: 0px 15px;" data-position="top" data-delay="50" data-tooltip="Eliminar"><i class="mdi-action-delete small"></i></a>
                                </td>
                            </tr>
                          @endforeach
                        </tbody>
            ...
            <div class="row">
                {{ $addresses->links('vendor.pagination.materiallize') }}
            </div>
